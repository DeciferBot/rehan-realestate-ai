...
/** Presentational dashboard home. Data-source agnostic so it can render from the
 *  live spine summary or a fixture (preview / tests) without divergence. */
export default function DashboardView({ s }: { s: DashboardSummary }) {
  return (
    <div>
      ...
      <div className="dash-grid" style={{ padding: "var(--space-9) var(--space-10)", display: "grid", gridTemplateColumns: "1fr 320px", gap: "var(--space-8)" }}>
        ...
        <Stack gap={8}>
          ...
          <Card style={{ padding: "var(--space-7)" }}>
            <Row between style={{ marginBottom: "var(--space-6)" }}>
              <Text size="md" weight="semibold">Conversion pipeline</Text>
          ...
          <Card flush>
            <Row between style={{ padding: "var(--space-6) var(--space-7) var(--space-5)", borderBottom: "1px solid var(--border)" }}>
              <Text size="md" weight="semibold">Live activity</Text>
              <Row gap={2}>
        ...
        <Stack gap={8}>
          ...
          {/* Acre at a glance */}
          <Card style={{ padding: "var(--space-7)" }}>
            <Text as="div" size="md" weight="semibold" style={{ marginBottom: "var(--space-6)" }}>Acre at a glance</Text>
          ...
          {/* Language breakdown */}
          <Card style={{ padding: "var(--space-7)" }}>
            <Text as="div" size="md" weight="semibold" style={{ marginBottom: "var(--space-6)" }}>Language breakdown</Text>
          ...
          <Card style={{ padding: "var(--space-7)" }}>
            <Text as="div" size="md" weight="semibold" style={{ marginBottom: "var(--space-6)" }}>Jump to</Text>
            <Stack gap={2}>
              {[
                ...
                <Link key={href} href={href} className={cx("u-btn", "u-btn--sm", variant, "jump-link")}>
                  <span>{label}</span>
                  <ChevronRight size={14} className="jump-link__chevron" strokeWidth={2} />
                </Link>
              ))}
            </Stack>
          </Card>
